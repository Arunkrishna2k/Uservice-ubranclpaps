<x-app-layout>
    <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2"><a href="{{ route('sub_category.index') }}" class="no-underline text-indigo">Sub Category List</a>
            </li>
            <li>/</li>
            <li class="px-2 text-gray-500">Show Sub Category List</li>
        </ol>
    </nav>
    <div>
                            ...
                            <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('ID') }} : <span
                                                class="text-pink-600">{{$subCategory->id}}</span>
                                        </p>
                                    </div>
                                </li>
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Sub Category Name') }} : <span
                                                class="text-pink-600">{{$subCategory->sub_category}}</span>
                                        </p>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <dd class="mt-1 text-xs text-gray-900 sm:mt-0 sm:col-span-1">
                            <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Remarks') }} : <span
                                                class="text-pink-600">{{$subCategory->remarks}}</span>
                                        </p>
                                    </div>
                                </li>
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Status') }} : <span
                                                class="text-pink-600">{{ $subCategory->status == 1 ? "Yes" : "No" }}</span>
                                        </p>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Created By') }} : <span
                                                class="text-pink-600">{{ $subCategory->created_by }}</span>
                                        </p>
                                    </div>
                                </li>
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Updated By') }} : <span
                                                class="text-pink-600">{{ $subCategory->updated_by }}</span>
                                        </p>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Created At') }} : <span
                                                class="text-pink-600">{{ $subCategory->created_at }}</span>
                                        </p>
                                    </div>
                                </li>
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                    <div class="ml-4 flex-shrink-0 font-bold">
                                        <p>{{ __('Updated At') }} : <span
                                                class="text-pink-600">{{ $subCategory->updated_at }}</span>
                                        </p>
                                    </div>
                                </li>
                            </ul>
