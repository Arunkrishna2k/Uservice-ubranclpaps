    ...
    <div>
        <div class="max-w-10xl mx-auto py-2 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('sub_category.update', $product->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-12 sm:col-span-12">
                                    @livewire('category-sub-category', ['params' => $product])
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <img height="50" wight="50" style="height:100px !important" src="/storage/{{$product->photo}}">
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <textarea type="text" name="remarks" id="remarks"
                                        class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                        value="{{ old('remarks', $product->remarks) }}"></textarea>
                                    @error('remarks')
                                        <p class="text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
