...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex-shrink-0 flex items-center font-weight-800 bg-white px-2">
                    U<span><strong>service</strong></span>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-6 sm:flex">
                    <x-jet-nav-link href="{{ route('sub_category.index') }}"
                                    :active="request()->routeIs('sub_category.*')">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-6 sm:flex">
                    <x-jet-nav-link href="{{ url('health') }}" :active="request()->routeIs('health.*')">
                        {{ __('Health Checkup') }}
                    </x-jet-nav-link>
                </div>
            </div>
