<x-app-layout>
    <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2"><a href="{{ route('sub_category.index') }}" class="no-underline text-indigo">Customer
                    List</a></li>
            <li>/</li>
            <li class="px-2 text-gray-500">Create Sub Category</li>
        </ol>
        </ol>
    </nav>
    <div>
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="sub_category" class="block font-medium text-xs text-gray-700">Sub
