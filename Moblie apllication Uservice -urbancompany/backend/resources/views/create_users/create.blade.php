<x-guest-layout>
    {{-- <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2"><a href="{{ route('create_users.index') }}" class="no-underline text-indigo">Customer List</a></li>
            <li>/</li>
    ...
    <div class="py-10">
        <div class="max-w-10xl mx-auto py-2 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('create_users.store') }}">
                    @csrf

                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <h1 class="text-blue-700 text-lg font-weight-bold">Register now! We will send you register confirmation to your registered mail</h1>

                            <div class="grid grid-cols-12 gap-6 py-10">
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="phone" class="block font-medium text-xs text-gray-700">Register
                                    ...
                                    <input type="text" name="register_number" id="register_number" maxlength="15"
                                        ...
                                        value="{{ old('register_number', $reg_no) }}" readonly/>
                                    @error('register_number')
                                        <p class="text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="customer_name" class="block font-medium text-xs text-gray-700">Customer
                                        Name</label>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="phone_number" class="block font-medium text-xs text-gray-700">Phone
                                        Number</label>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="register_type" class="block font-medium text-xs text-gray-700">Register
                                        type</label>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="mci_number" class="block font-medium text-xs text-gray-700">MCI
                                        Number</label>
