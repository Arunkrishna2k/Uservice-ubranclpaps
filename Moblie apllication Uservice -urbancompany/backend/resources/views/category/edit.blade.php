<x-app-layout>
    <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2"><a href="{{ route('category.index') }}" class="no-underline text-indigo">Category List</a></li>
            <li>/</li>
            <li class="px-2 text-gray-500">Update Category List</li>
        </ol>
    </nav>
    <div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-4 sm:col-span-4">
                                    <label for="category" class="block font-medium text-xs text-gray-700">Category Name<span
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <img height="50" wight="50" style="height:100px !important" src="/storage/{{$category->photo}}">
                                ...
                                <div class="col-span-4 sm:col-span-4">
                                    ...
                                    <textarea type="text" name="remarks" id="remarks"
                                              class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                              value="{{ old('remarks', $category->remarks) }}">{{ $category->remarks }}</textarea>
                                    @error('remarks')
                                    <p class="text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
