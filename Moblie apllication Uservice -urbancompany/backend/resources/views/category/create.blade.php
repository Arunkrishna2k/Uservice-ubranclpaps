<x-app-layout>
    <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2"><a href="{{ route('category.index') }}" class="no-underline text-indigo">Customer List</a></li>
            <li>/</li>
            <li class="px-2 text-gray-500">Create Category</li>
        </ol>
        </ol>
    </nav>
    <div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="phone" class="block font-medium text-xs text-gray-700">Category Name<span class="text-red-500">&#42;</span></label>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="photo" class="block font-medium text-xs text-gray-700">Photo</label>
                                    <input type="file" name="photo" id="photo"
                                           class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                           value="{{ old('photo', '') }}" />
                                    @error('photo')
                                    <p class="text-xs text-red-600">{{ $photo }}</p>
                                    @enderror
                                </div>
                                <div class="col-span-12 sm:col-span-3">
