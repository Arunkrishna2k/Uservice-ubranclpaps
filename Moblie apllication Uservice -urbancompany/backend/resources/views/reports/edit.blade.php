<x-app-layout>
    <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2 text-gray-500">Update Customer List</li>
        </ol>
    </nav>
    <div>
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-4 sm:col-span-4">
                                    <label for="register_number" class="block font-medium text-xs text-gray-700">Register Number<span
                                ...
                                <div class="col-span-4 sm:col-span-4">
                                    ...
                                    <input type="text" name="customer_name" id="customer_name" maxlength="15"
                                           class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                ...
                                <div class="col-span-4 sm:col-span-4">
                                    <label for="register_type" class="block font-medium text-xs text-gray-700">Register Type</label>
                                        <select id="register_type" name="register_type" autocomplete="register_type"
                                            ...
                                            <option value="Senior Citizen"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>Senior Citizen</option>
                                            <option value="Consultant IAP Member"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>Consultant IAP Member</option>
                                            <option value="Consultant Non- Member"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>Consultant Non- Member</option>
                                            <option value="PG Non - Member"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>PG Non - Member</option>
                                            <option value="IAP"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>IAP</option>
                                            <option value="PG IAP Member"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>PG IAP Member</option>
                                            <option value="NON IAP MEMBER"{{ $customer->register_type == "HIA Staff" ? 'selected' : '' }}>NON IAP MEMBER</option>
                                        </select>
                                    @error('register_type')
                                    <p class="text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-span-4 sm:col-span-4">
                                    ...
                                    <input type="number" name="mci_number" id="mci_number"
                                           class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                           value="{{ old('mci_number', $customer->mci_number) }}"/>
                                    @error('mci_number')
                                    <p class="text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-span-4 sm:col-span-4">
                                    <label for="remarks"
                                           ...
                                           class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                           value="{{ old('remarks', $customer->remarks) }}">{{ $customer->remarks }}</textarea>
                                    @error('remarks')
                                    <p class="text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 hidden">
                            ...
                            <input type="number" name="created_by" id="created_by"
                                   class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
                                   value="{{ old('created_by', $customer->created_by) }}"/>
                            @error('created_by')
                            <p class="text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
