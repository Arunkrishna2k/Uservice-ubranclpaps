<x-app-layout>
    <nav class="container">
        <ol class="list-reset py-4 pl-4 rounded flex bg-grey-light text-grey">
            ...
            <li>/</li>
            <li class="px-2"><a href="{{ route('datas.index') }}" class="no-underline text-indigo">Block List</a></li>
            <li>/</li>
            <li class="px-2 text-gray-500">Create Block List</li>
        </ol>
    </nav>
    <div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="phone" class="block font-medium text-xs text-gray-700">Phone<span class="text-red-500">&#42;</span></label>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    <label for="name" class="block font-medium text-xs text-gray-700">Name<span class="text-red-500">&#42;</span></label>
